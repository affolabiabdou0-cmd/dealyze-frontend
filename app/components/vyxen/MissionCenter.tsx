...
export default function MissionCenter({ onOpenDemo }: { onOpenDemo: () => void }) {
  ...
  return (
    <section className="px-4 md:px-8" style={{ background: "var(--color-panel)", paddingTop: 90, paddingBottom: 100, borderTop: "0.5px solid var(--color-hairline)", position: "relative", overflow: "hidden" }}>
