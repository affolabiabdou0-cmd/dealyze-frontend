...
export default function WorldSection() {
  ...
  return (
    <section className="px-4 md:px-8" style={{ background: "rgba(5,5,7,0.72)", paddingTop: 90, paddingBottom: 60, borderTop: "0.5px solid var(--color-hairline)", overflow: "hidden" }}>
