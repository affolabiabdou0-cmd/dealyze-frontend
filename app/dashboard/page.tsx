...
import {
  ...
  CheckCircle, TrendingUp, Sparkles, Clock, Zap,
} from "lucide-react";
...
const ACTIVITY = [
  { icon: CheckCircle, color: "#10b981", bg: "#f0fdf4", title: "Facture #2291 encaissée avec succès",        sub: "Atlas Logistique · 4 280 €",              time: "12 min"  },
  { icon: Mail,        color: "#f97316", bg: "#fff7ed", title: "Relance niveau 2 transmise",                  sub: "Maison Verlaine · Facture #2287 · 2 150 €", time: "1h"      },
  { icon: BarChart3,   color: "#06b6d4", bg: "#ecfeff", title: "Pitch analysé — Score de confiance 7,8/10",  sub: "Nova Health · Série Seed",                time: "2h"      },
  { icon: FileText,    color: "#7c3aed", bg: "#ede9fe", title: "Proposition #DV-2026-118 remise au client",  sub: "Solaris Énergie · 18 400 €",              time: "4h"      },
  { icon: Shield,      color: "#10b981", bg: "#f0fdf4", title: "Due diligence finalisée — Risque modéré",    sub: "Helix Robotics · Recommandation : Vigilance", time: "hier"  },
  { icon: Sparkles,    color: "#7c3aed", bg: "#ede9fe", title: "Nouveau modèle de relance déployé",          sub: "Délai moyen de paiement estimé à -3 jours",  time: "hier"  },
];
...
const QUICK = [
  ...
  { href: "/dashboard/pitch-radar", icon: BarChart3, color: "#06b6d4", bg: "#ecfeff", name: "Pitch Radar", desc: "Notation IA d'un pitch deck en moins d'une minute"  },
  { href: "/dashboard/deep-due",    icon: Shield,    color: "#10b981", bg: "#f0fdf4", name: "Deep Due",    desc: "Due diligence complète sur une cible d'investissement" },
];
    ...
    <div className="space-y-6 h-full">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        {STATS.map(({ key, label, icon: Icon, color, iconBg }) => {
          ...
          const lim = q?.limite;
          const pct = lim && lim !== "illimité" && lim > 0 ? Math.min(100, (val / (lim as number)) * 100) : null;
          return (
            ...
            {ACTIVITY.map((item, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-4 px-6 py-4"
                  ...
                  <div style={{ fontSize: 11, color: "#cbd5e1", flexShrink: 0, whiteSpace: "nowrap" }}>
                    il y a {item.time}
                  </div>
                </div>
              );
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link href="/dashboard/deal-draft" style={{ textDecoration: "none" }}>
            <div style={{
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 32px rgba(124,58,237,0.38)"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.boxShadow = "0 8px 24px rgba(124,58,237,0.25)"; }}
            >
              ...
              <div style={{
                ...
                padding: "8px 16px", background: "rgba(255,255,255,0.16)",
